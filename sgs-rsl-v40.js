  ...
  try{
    ...
    if(msg){
      ...
      msg.textContent=failedItems.length
        ?`V4.2.2 completed for ${r||'this report'}. ${failedItems.length} failed item(s) found and ${filled}/5 metadata fields filled. Verify against the PDF.`
        :`V4.2.2 found no verified failed result in ${r||'this report'}. ${filled}/5 metadata fields filled. Add failed items manually.`;
      msg.classList.remove('hidden');
    }
  }catch(e){
    console.error('SGS RSL V4.2.2',e);
...
window.SGSRSLV422={parse,parseBisphenolsV42,reportNo,extractMetadata};
window.SGSRSLV421=window.SGSRSLV422;
window.SGSRSLV42=window.SGSRSLV422;
